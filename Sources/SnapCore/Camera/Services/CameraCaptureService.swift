...
public actor CameraCaptureService: CameraCaptureProviding {
    ...
    internal var onDetailedFaceResult: (([DetailedFace], CVPixelBuffer, CFAbsoluteTime) -> Void)?
    internal var cameraState: CameraState = .cameraStopped

    // Vision Framework Handlers
    internal var recognitionDispatcher: RecognitionDispatcher?
    ...
    internal var detailedFaceRecognizer: DetailedFaceRecognitionHandler?
